...
int lightControl = 0;                 int* p_lightControl = &lightControl;
...
int* pointer_array[]={p_lick_mode, p_trial, p_trial_set, p_now_pos, p_lick_rec_pos, p_INDEBUGMODE, p_OGActiveMills, p_miniscopeRecord, p_waterServeWhenLick, p_waterServeManual, p_lightControl};
...
void print_status(String _head=""){
  ...
  sprintf(log_buffer, " lick_mode%d, tria %d, tempTrialStautsMark%d, now_pos%d, INDEBUGMODE%d, waiting%d, OGAMills%d, MSRecord%d, waterServeManual%d, lightCon%d " ,
                        lick_mode, trial, tempTrialStautsMark, now_pos, INDEBUGMODE, waiting, OGActiveMills, miniscopeRecord, waterServeManual, lightControl);
